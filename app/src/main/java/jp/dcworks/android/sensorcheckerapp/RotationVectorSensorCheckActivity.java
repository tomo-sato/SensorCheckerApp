...
public class RotationVectorSensorCheckActivity extends SensorCheckBaseActivity {
    @Override
    ...
    @Override
 	protected void onResume() {
     	...
     	Sensor linearAccelerometerSensor = sensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);
     	//リスナー登録
